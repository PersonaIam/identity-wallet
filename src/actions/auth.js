 ...
 */
import {blockchain, http} from 'config/http';
...
export const confirmAccount = (data) => async (dispatch) => {
  try {
    ...
    if (process.env.NODE_ENV === 'development') {
      const putData = {
        senderPublicKey: '025dfd3954bf009a65092cfd3f0ba718d0eb2491dd62c296a1fff6de8ccd4afed6',
        secret: 'blade early broken display angry wine diary alley panda left spy woman',
        amount: 50000,
        recipientId: data.address
      };

      await blockchain.put('/transactions', putData);
    }
